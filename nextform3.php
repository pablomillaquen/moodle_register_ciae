...
$PAGE->set_url('/local/registerciae/nextform3.php');
...
$data = new stdClass();
$data->image = "#";
$data->title = "Ficha de identidad territorial";
$data->percentage = intval($percentage2);

$results->name_ficha = $data->title;
$results->homelink = $CFG->wwwroot;
...
echo $OUTPUT->render_from_template('local_registerciae/nextform3', $results);
